...
describe "#multiply" do
  ...
  it "multiplies two numbers positive and negative" do
    expect(multiply(3, -4)).to eq(-12)
  end
    # one other test here, don't forget do end ;)

    it "multiplies two floating numbers" do
      expect(multiply(3.5, 4.5)).to eq(15.75)
    end
...
describe "#power" do
  it "raises 5one number to the power of another number" do
